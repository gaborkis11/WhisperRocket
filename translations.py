...
TRANSLATIONS = {
    "en": {
        ...
        "ai_dict_edit": "Edit",
        "ai_dict_hint": "Corrects names the recogniser gets wrong. Works even with AI cleanup switched off.",
    ...
    "hu": {
        ...
        "ai_dict_edit": "Szerkesztés",
        "ai_dict_hint": "A felismerő által elrontott neveket javítja. AI tisztítás nélkül is működik.",
