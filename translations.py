...
TRANSLATIONS = {
    "en": {
        ...
        "ai_style_edit": "Edit",
        "ai_style_hint": "Describes how you write. Kept outside the project directory and never committed.",
        ...
        "ai_dict_hint": "If the recogniser keeps getting a name or a technical term wrong, put the right spelling here - for example \"tail scale\" becomes Tailscale. Works even with AI cleanup switched off.",
        "ai_dict_col_correct": "Correct spelling",
        "ai_dict_col_heard": "What it hears instead",
        "ai_dict_col_auto": "Auto",
        "ai_dict_add": "+ Add",
        "ai_dict_remove": "\u2212 Remove",
        "ai_dict_heard_tip": "Separate several with commas. Add the inflected forms too if you want those corrected - matching respects word boundaries.",
        "ai_dict_auto_tip": "Ticked: replaced automatically before the AI sees the text. Unticked: only offered to the AI as a hint, which decides from context.",
        "ai_dict_empty": "No entries yet. Use + Add to create one.",
        "ai_dict_persist": "kept after every restart once saved",
    ...
    "hu": {
        ...
        "ai_style_hint": "Azt írja le, hogyan írsz. A projektmappán kívül tárolódik, és soha nem kerül verziókövetésbe.",
        ...
        "ai_dict_hint": "Ha a felismerő rendszeresen elront egy nevet vagy szakszót, itt megadhatod a helyes alakot - például a \"tail scale\"-ből Tailscale lesz. AI tisztítás nélkül is működik.",
        "ai_dict_col_correct": "Helyes alak",
        "ai_dict_col_heard": "Amit félrehall",
        "ai_dict_col_auto": "Auto",
        "ai_dict_add": "+ Hozzáadás",
        "ai_dict_remove": "\u2212 Törlés",
        "ai_dict_heard_tip": "Több alakot vesszővel válassz el. Ha a ragozott formákat is javítani szeretnéd, azokat is írd be - a keresés szóhatárra illeszkedik.",
        "ai_dict_auto_tip": "Bepipálva: a program automatikusan kicseréli, még mielőtt az AI látná. Kipipálva: csak javaslatként adjuk át az AI-nak, ő dönt a szövegkörnyezet alapján.",
        "ai_dict_empty": "Még nincs bejegyzés. A + Hozzáadás gombbal vehetsz fel egyet.",
        "ai_dict_persist": "a Mentés után minden újraindítás után megmarad",
